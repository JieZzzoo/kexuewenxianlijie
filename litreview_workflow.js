...
const htmlToFile = node({
  type: 'n8n-nodes-base.convertToFile',
  version: 1.1,
  config: { name: 'Report HTML To File', parameters: { operation: 'toText', sourceProperty: 'htmlReport', binaryPropertyName: 'data', options: { dataIsBase64: false, encoding: 'utf8', fileName: '文献精读报告.html', mimeType: 'text/html' } }, position: [4700, 400] },
  output: [{}],
});
